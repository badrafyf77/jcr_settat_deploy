...
import 'package:jcr_settat/features/events/presentation/views/mobile/widgets/event_info_column.dart';

class MobileEventInfoBody extends StatelessWidget {
  const MobileEventInfoBody({
    super.key,
    required this.id,
  });
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  MobileEventInfoColumn(event: state.event),
                ],
              ),
            ),
          );
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 15),
                  MobileEventInfoColumn(event: fakeEvent),
                ],
              ),
            ),
          ),
